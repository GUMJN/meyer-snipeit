                        ...
                        <td style="{{ $style['email-masthead'] }}">
                            ...
                            @if (($snipeSettings->show_images_in_email=='1' ) && ($snipeSettings::setupCompleted()))
                                ...
                                @if ($snipeSettings->brand == '3')
                                    @if ($logo!='')
                                        <img class="navbar-brand-img logo" style="max-width: 200px;" src="{{ config('app.url') }}/uploads/{{ $logo }}">
                                    @endif
                                ...
                                <tr>
                                    <td style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
                                        ...
                                        <h1 style="{{ $style['header-1'] }}">
                                            Ein Asset wurde aktualisiert:
                                        </h1>

                                        <table width="100%" cellpadding="5" cellspacing="0" border="1" style="border-collapse: collapse; margin-top: 20px;">
                                            <tr>
                                            ...
                                            <tr>
                                                <td>Asset-Tag</td>
                                                <td><a href="{{ config('app.url') }}/hardware/{{ $assetId }}">{{ $assetTag }}</a></td>
                                            </tr>
                                            <tr>
                                                <td>Modell</td>
                                                <td>{{ $assetModel }}</td>
